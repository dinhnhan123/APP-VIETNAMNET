...
import PoliticsVerticalItem from "./PoliticsVerticalItem";
import "../../styles/politics/politicsVerticalList.css";

const PoliticsVerticalList = () => {
   const articles = [
        {
    ...
    return (
        <div className="politics-vertical-list">
            ...
            {currentArticles.map((item, index) => (
                <PoliticsVerticalItem key={index} {...item} />
            ))}
...
export default PoliticsVerticalList;
