...
import BusinessThreeGrid from "./BusinessThreeGrid.jsx";
import BusinessVerticalList from "./BusinessVerticalList.jsx";
        ...
        <div className="politics-main">
            ...
            <div className="mt-4">
             ...
             <div className="news-row mt-4">
                <BusinessSection sections={listDataBusiness} />
                <BusinessSection sections={listDataBusiness1} />
            </div>
        </div>
